...
# why is linter forcing this line to go on the next line? research later
...
firstInitial = ["C", "D", "E", "F", "G"]
print("Starts between C and G, inclusive:")
c = [person.name for person in humans if person.name[0] in firstInitial]
print(c)
...
# linter did that weird thing again
